...
Inreal_CYLINDER_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        fix_base=False,
        replace_cylinders_with_capsules=True,
        asset_path=f"{ASSET_DIR}/inreal_description/urdf/inreal.urdf",
...
Inreal_ACTION_SCALE = {}
for a in Inreal_CYLINDER_CFG.actuators.values():
    ...
    for n in names:
        if n in e and n in s and s[n]:
            Inreal_ACTION_SCALE[n] = 0.25 * e[n] / s[n]
